...
newRasterfn1 = './PF_predictions/PF_prediction_ERF.tif'
...
'''
df_fullData = pd.DataFrame({'chm':chm,'aspect':aspect,'elev':elev,'tpi':tpi,'slope':slope,'tri':tri,'curv':curv,'da':da,'snow':snow,'ndvi':ndvi})
df_fullData=df_fullData.dropna()

X_FULL=df_fullData[['chm','aspect','elev','slope','curv','snow','ndvi']]
...
# plt.ylim(bottom=0)
# fig.tight_layout()
# plt.savefig(r'C:\Users\361045\Documents\projects\ngee\machineLearningData\t47\Figs\featureImportancePermutation.jpg',dpi=300)
# plt.show()
...
'''
y_full_pred=clf_erf.predict(X_FULL)
